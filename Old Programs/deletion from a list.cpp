...
int main()
{
    ...
    } /* therefore at the end, the values of the last and the second last element become the same since boi[5] doesnt have any boi[6] it can become equal to.*/
    boi[5]=0;  /* setting the last element to zero so that you get the required list with the deleted element with a zero at the end.*/
    cout<<sizeof(boi)<<"\n";
